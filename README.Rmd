...
knitr::opts_chunk$set(
  collapse = TRUE,
  comment = "#>",
  fig.path = "vignettes/webimg/README-"
)
set.seed(0)
```
...
![CRAN Downloads](http://cranlogs.r-pkg.org/badges/biwavelet)
[![Research software impact](http://depsy.org/api/package/cran/biwavelet/badge.svg)](http://depsy.org/package/r/biwavelet)
[![Support badge]( https://img.shields.io/badge/support-biwavelet-yellowgreen.svg)](http://stackoverflow.com/questions/tagged/biwavelet)
...
```{r wtc_mei_npgo, include=FALSE, cache=TRUE}
data(enviro.data)
...
spectrum](vignettes/webimg/wclust.png)
